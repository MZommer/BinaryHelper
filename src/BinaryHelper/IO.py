...
class IOBase:
    ...
    def pack(self, format, *args) -> None:
        return struct.pack(format, *args)
    
    def pack_into(self, format, *args) -> None:
        return struct.pack_into(format, self._buffer, *args)
    
    def unpack(self, format, *args) -> None:
        return struct.unpack(format, *args)
    
    def unpack_into(self, format, *args) -> None:
        return struct.unpack_into(format, self._buffer, *args)

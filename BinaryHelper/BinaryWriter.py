...
class BinaryWriter(BaseIO):
    ...
    ### Types ###
    def bool(self, value: Union[bool, int]):
        if not isinstance(value, bool):
            value = bool(value)
        return self.auto(value)

    def char(self, value: Union[dtypes.int8, int]):
        return self.int8(value)

    def uchar(self, value: Union[dtypes.uint8, int]):
        return self.uint8(value)

    def byte(self, value: Union[dtypes.int8, int]):
        return self.int8(value)

    def ubyte(self, value: Union[dtypes.uint8, int]):
        return self.uint8(value)

    def int8(self, value: Union[dtypes.int8, int]):
    ...
    def uint8(self, value: Union[dtypes.uint8, int]):
    ...
    def short(self, value: Union[dtypes.int16, int]):
        return self.int16(value)

    def ushort(self, value: Union[dtypes.uint16, int]):
        return self.uint16(value)

    def int16(self, value: Union[dtypes.int16, int]):
    ...
    def uint16(self, value: Union[dtypes.uint16, int]):
    ...
    def long(self, value: Union[dtypes.int32, int]):
        return self.int32(value)

    def ulong(self, value: Union[dtypes.uint32, int]):
        return self.uint32(value)

    def int32(self, value: Union[dtypes.int32, int]):
    ...
    def uint32(self, value: Union[dtypes.uint32, int]):
    ...
    def longlong(self, value: Union[dtypes.int64, int]):
        return self.int64(value)

    def ulonglong(self, value: Union[dtypes.uint64, int]):
        return self.uint64(value)

    def int64(self, value: Union[dtypes.int64, int]):
    ...
    def uint64(self, value: Union[dtypes.uint64, int]):
    ...
    def half(self, value: Union[dtypes.float16, float, int]):
        return self.float16(value)

    def float16(self, value: Union[dtypes.float16, float, int]):
    ...
    def single(self, value: Union[dtypes.float32, float, int]):
        return self.float32(value)

    def float32(self, value: Union[dtypes.float32, float, int]):
    ...
    def double(self, value: Union[dtypes.float64, float, int]):
        return self.float64(value)

    def float64(self, value: Union[dtypes.float64, float, int]):
    ...
    def float(self,  value: Union[dtypes.float32, float, int]):
        return self.float32(value)
